...
console.log('Smller than 10');
}

let day = new Date("2025-09-28").getDay();
console.log(day);
...
let days = ['Pühapäev', 'Esmapäev', 'Teisipäev', 'Kolmapäev', 'Neljapäev', 'Pidupäev', 'Pidupäev'];
